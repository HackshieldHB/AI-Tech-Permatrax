...
import { ProjectDailyActivityInterceptor } from './common/interceptors/project-daily-activity.interceptor'; // Integra V10
...
@Module({
  ...
  providers: [
    ...
    {
      provide: APP_INTERCEPTOR,
      useClass: ProjectDailyActivityInterceptor, // Integra V10 — Daily Activity all-user project feed
    },
    {
      provide: APP_GUARD,
